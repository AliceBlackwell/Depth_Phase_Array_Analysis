...
class crustModel:
    ...
    def __init__(self):
        # Read in data files
        self.vp = np.loadtxt('/localhome/not-backed-up/ee18ab/09_pmP/Rewritten_pmP_Code_Jan_2025/Velocity_model_files/Crust1.0/model/crust1.vp')
        self.vs = np.loadtxt('/localhome/not-backed-up/ee18ab/09_pmP/Rewritten_pmP_Code_Jan_2025/Velocity_model_files/Crust1.0/model/crust1.vs')
        self.rho = np.loadtxt('/localhome/not-backed-up/ee18ab/09_pmP/Rewritten_pmP_Code_Jan_2025/Velocity_model_files/Crust1.0/model/crust1.rho')
        self.bnds = np.loadtxt('/localhome/not-backed-up/ee18ab/09_pmP/Rewritten_pmP_Code_Jan_2025/Velocity_model_files/Crust1.0/model/crust1.bnds')
